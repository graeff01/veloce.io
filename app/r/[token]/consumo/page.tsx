...
import { PortalConsumo } from "@/components/portal/portal-consumo";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

export default async function ConsumoPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <main className="fmain">
      ...
      <PortalShell token={token} brandName={client?.name || "Painel"} logoUrl={client?.logoUrl ?? null} active="consumo" sections={shell.sections} account={shell.account} aiTest={shell.aiTest} />
