...
export default async function EquipePage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <main className="tmain">
      ...
      <PortalMobileNav token={token} active={"equipe"} sections={shell.sections} quotesEnabled={shell.quotesEnabled} />
      <PortalMobileHeader token={token} titulo="Equipe" account={shell.account} sections={shell.sections} quotesEnabled={shell.quotesEnabled} />
