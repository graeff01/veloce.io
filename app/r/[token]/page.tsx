      ...
      <div className="pwrap">
        ...
        <div className="pcol pcol-atd">
          ...
          <div className="ptiles">
            ...
            <Link href={`/r/${token}/conversas`} prefetch style={{ ...card, display: "flex", flexDirection: "column", justifyContent: "center", gap: 8, border: "none", background: "#25D366", textDecoration: "none", boxShadow: "0 6px 18px rgba(37,211,102,.30)" }}>
