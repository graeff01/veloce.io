...
// GET /api/client/report?year=&month=  → PDF executivo do cliente logado.
// clientId vem SEMPRE da sessão — cliente nunca acessa relatório de outro.
export async function GET(req: Request) {
  ...
  const data = await computeExecutiveReport(clientId, year, month);
