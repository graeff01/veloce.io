// Corpo da Política de Privacidade da Veloce (LGPD). Fonte ÚNICA — usado tanto na página
...
export function PrivacyPolicyContent() {
  return (
    <div style={{ color: "#1f2937", fontFamily: "system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif", lineHeight: 1.65, fontSize: 14.5 }}>
      <h1 style={{ fontSize: 26, fontWeight: 800, margin: "0 0 4px", color: "#111827" }}>Política de Privacidade</h1>
      <p style={{ color: "#6b7280", marginTop: 0, fontSize: 13 }}>Última atualização: {PRIVACY_UPDATED_AT}</p>
