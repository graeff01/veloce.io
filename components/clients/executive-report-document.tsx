...
const BARBG = "#EEF2F6";
const ACCENT = "#4F46E5";     // acento de marca (indigo Veloce.io) — usado com parcimônia
    ...
    <Document title={`Relatório Executivo — ${data.clientName}`} author="Veloce.io">
      ...
      <Page size="A4" style={s.page}>
        <View style={s.cover}>
          ...
          <Text style={s.coverTitle}>{"Seguimos à disposição.\nVamos evoluir a operação no próximo ciclo..."}</Text>
          <View style={s.coverRule} />
          <View style={s.metaBlock}>
