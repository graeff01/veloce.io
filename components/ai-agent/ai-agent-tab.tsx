  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={card}>
        ...
        <label style={{ ...label, marginTop: 14 }}>Selo de confiança (citado na abertura)</label>
        <input style={input} value={cfg.trustHighlights ?? ""} onChange={(e) => set({ trustHighlights: e.target.value })} placeholder="Ex: todos com laudo cautelar e garantia de até 2 anos" />
        <p style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 4 }}>A IA cita esse diferencial logo na 1ª mensagem (credibilidade). Em branco, não cita.</p>
